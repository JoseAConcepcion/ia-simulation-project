...
while total_victories < 100:
    ...
    poly5 = [[-0.5,0.3], [-0.5,-0.3], [1,1], [0.5,0.3]]
    poly5_1 = [[1,0], [0,0.3], [-1,0]]
    f5.mass_density = 3.12
    f5.add_polygon(poly5)
    f5.add_polygon(poly5_1)
    #print(f5.body.mass)

    f6 = Fighter([1,-7], 2, physW, fighter_standard_personality)
    poly6 = [[0,1], [-0.5,0], [1,0]]
    poly6_1 = [[-0.5,0.3], [-0.5,-0.3], [1,1], [0.5,0.3]]
    f6.mass_density = 2.12
    f6.add_polygon(poly6_1)
