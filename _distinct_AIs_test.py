...
while total_victories < 100:
    ...
    f3 = Fighter([5,4], 1, physW, fighter_paranoic_personality)
    f3.add_polygon(poly1)

    f4 = Fighter([5,5], 1, physW, fighter_paranoic_personality)
    f4.add_polygon(poly2)

    f5 = Fighter([0,-7], 2, physW, fighter_planifier_personality)
    f5.add_polygon(poly1)

    f6 = Fighter([1,-7], 2, physW, fighter_planifier_personality)
